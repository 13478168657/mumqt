...
<div class="change_tel" id="sc" style="top:250px;">
  ...
  <h2>确认删除</h2>
  <div class="change3">
    <p class="p" style="width:200px;"><i></i>您确定要删除户型信息吗?</p>
  </div>
  <div class="submit">
    <a class="btn back_color margin_r" id="saveDelete">确定</a>
...
/** 户型信息-住宅 **/
  ...
  var roomName, weizhi, arr = new Array(), room, hall, toilet, kitchen, balcony, faceTo, floorage, usableArea, num, state, price, cbIds, uIds = '', feature, leyout, rId, delImg = new Array();
...
function edithuxing(obj){
    ...
    if( typeof image != 'null' || typeof image != 'undefined'){
        ...
        for( var i in image){
            ...
            lis += '<div class="viewThumb"><img src="'+ '{{config("imgConfig.imgSavePath")}}' +image[i].fileName +'" value="'+ '{{config("imgConfig.imgSavePath")}}' +image[i].fileName +'"></div>';
