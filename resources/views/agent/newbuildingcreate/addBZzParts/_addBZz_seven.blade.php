...
@if($typeInfo == 303)
    ...
    <ul class="input_msg enter_build">
        <li>
            ...
            <input type="hidden" name="homeDesignType" datatype="*" nullmsg="请选择房屋类别" @if(!empty($type2GetInfo)) value="{{$type2GetInfo->homeDesignType}}" @endif />
        </li>
        <li>
        ...
        <li class="no_height">
            <label><span class="dotted colorfe">*</span>服务配套设施：</label>
            <input type="checkbox" name="supportService" value="1" class="radio" datatype="*" nullmsg="请选择服务配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportService == 1) checked="checked" @endif @endif />
            <span class="tishi">客房清洁</span>
            <input type="checkbox" name="supportService" value="2" class="radio" datatype="*" nullmsg="请选择服务配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportService == 2) checked="checked" @endif @endif />
            <span class="tishi">洗衣熨烫</span>
            <input type="checkbox" name="supportService" value="3" class="radio" datatype="*" nullmsg="请选择服务配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportService == 3) checked="checked" @endif @endif />
            <span class="tishi">健身房</span>
            <input type="checkbox" name="supportService" value="4" class="radio" datatype="*" nullmsg="请选择服务配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportService == 4) checked="checked" @endif @endif />
            <span class="tishi">泳池</span>
            <input type="checkbox" name="supportService" value="5" class="radio" datatype="*" nullmsg="请选择服务配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportService == 5) checked="checked" @endif @endif />
            <span class="tishi">可注册</span>
            <input type="checkbox" name="supportService" value="6" class="radio" datatype="*" nullmsg="请选择服务配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportService == 6) checked="checked" @endif @endif />
            <span class="tishi">商务中心</span>
            <input type="checkbox" name="supportService" value="7" class="radio" datatype="*" nullmsg="请选择服务配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportService == 7) checked="checked" @endif @endif />
            <span class="tishi">24小时大堂经理</span>
            <input type="checkbox" name="supportService" value="8" class="radio" datatype="*" nullmsg="请选择服务配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportService == 8) checked="checked" @endif @endif />
            <span class="tishi">送餐服务</span>
            <input type="checkbox" name="supportService" value="9" class="radio" datatype="*" nullmsg="请选择服务配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportService == 9) checked="checked" @endif @endif />
            <span class="tishi">叫车服务</span>
        </li>
        <li class="no_height">
            <label><span class="dotted colorfe">*</span>室内配套设施：</label>
            <input type="checkbox" name="supportIndoor" value="1" class="radio" datatype="*" nullmsg="请选择室内配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportIndoor == 1) checked="checked" @endif @endif />
            <span class="tishi">中央空调</span>
            <input type="checkbox" name="supportIndoor" value="2" class="radio" datatype="*" nullmsg="请选择室内配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportIndoor == 2) checked="checked" @endif @endif />
            <span class="tishi">24小时热水</span>
            <input type="checkbox" name="supportIndoor" value="3" class="radio" datatype="*" nullmsg="请选择室内配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportIndoor == 3) checked="checked" @endif @endif />
            <span class="tishi">冰箱</span>
            <input type="checkbox" name="supportIndoor" value="4" class="radio" datatype="*" nullmsg="请选择室内配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportIndoor == 4) checked="checked" @endif @endif />
            <span class="tishi">洗衣机</span>
            <input type="checkbox" name="supportIndoor" value="5" class="radio" datatype="*" nullmsg="请选择室内配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportIndoor == 5) checked="checked" @endif @endif />
            <span class="tishi">电视</span>
            <input type="checkbox" name="supportIndoor" value="6" class="radio" datatype="*" nullmsg="请选择室内配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportIndoor == 6) checked="checked" @endif @endif />
            <span class="tishi">家具</span>
            <input type="checkbox" name="supportIndoor" value="7" class="radio" datatype="*" nullmsg="请选择室内配套设施" @if(!empty($type2GetInfo)) @if($type2GetInfo->supportIndoor == 7) checked="checked" @endif @endif />
            <span class="tishi">高速网络</span>
        </li>
        <li class="no_height">
