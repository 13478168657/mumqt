    ...
    <div class="examine">
      <table class="audit">
        ...
        <tr>
          ...
          <td><a class="modaltrigger" value="{{$val->id}}" onclick="edit_yj(this);" href="#add">修改</a>&nbsp;&nbsp;<a class="modaltrigger" value="{{$val->id}}" onclick="del_info(this);" href="#sc">删除</a></td>
        </tr>
        @endforeach
        <tr>
          <td colspan="8">
