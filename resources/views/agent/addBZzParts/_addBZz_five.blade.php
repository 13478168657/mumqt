...
@if($typeInfo == 304)
    ...
    <ul class="input_msg enter_build">
        <li>
            ...
            <input type="checkbox" name="roomType" class="radio" name="roomType" value="1"  checked="checked" @if(!empty($type2GetInfo)) @if($type2GetInfo->roomType == 1) checked="checked" @endif @endif />
            <span class="tishi">独栋</span>
            <input type="checkbox" name="roomType" class="radio" name="roomType" value="2" @if(!empty($type2GetInfo)) @if($type2GetInfo->roomType == 2) checked="checked" @endif @endif />
            <span class="tishi">双拼</span>
            <input type="checkbox" name="roomType" class="radio" name="roomType" value="3" @if(!empty($type2GetInfo)) @if($type2GetInfo->roomType == 3) checked="checked" @endif @endif />
            <span class="tishi">联排</span>
            <input type="checkbox" name="roomType" class="radio" name="roomType" value="4" @if(!empty($type2GetInfo)) @if($type2GetInfo->roomType == 4) checked="checked" @endif @endif />
            <span class="tishi">叠拼</span>
            <input type="checkbox" name="roomType" class="radio" name="roomType" value="5" @if(!empty($type2GetInfo)) @if($type2GetInfo->roomType == 5) checked="checked" @endif @endif />
