 ...
 */
  ...
  //住宅底商,商业街商铺,临街门面,写字楼配套底商,其它

?>

@if($typeInfo == 101 || $typeInfo == 102 || $typeInfo == 103 || $typeInfo == 104 || $typeInfo == 106)
    <p class="caption">
    ...
    <ul class="input_msg enter_build">
        ...
        <li>
            <label><span class="dotted colorfe">*</span>是否可隔层：</label>
            <input type="radio" name="isDivisibility" class="radio" checked="checked" value="0" name="isDivisibility" @if(!empty($type2GetInfo)) @if($type2GetInfo->isDivisibility == 0) checked="checked" @endif @endif />
            <span class="tishi">是</span>
            <input type="radio" name="isDivisibility" class="radio" value="1" name="isDivisibility" @if(!empty($type2GetInfo)) @if($type2GetInfo->isDivisibility == 1) checked="checked" @endif @endif />
        ...
        <li class="no_height">
            ...
            <input type="checkbox" class="radio" name="trade[]" value="1" checked="checked" @if(!empty($type2GetInfo->trade)) @if(in_array('1',explode('|',$type2GetInfo->trade))) checked="checked" @endif @endif />
            <span class="tishi">餐饮美食</span>
            <input type="checkbox" class="radio" name="trade[]" value="2" @if(!empty($type2GetInfo->trade)) @if(in_array('2',explode('|',$type2GetInfo->trade))) checked="checked" @endif @endif />
            <span class="tishi">服饰鞋包</span>
            <input type="checkbox" class="radio" name="trade[]" value="3" @if(!empty($type2GetInfo->trade)) @if(in_array('3',explode('|',$type2GetInfo->trade))) checked="checked" @endif @endif />
            <span class="tishi">休闲娱乐</span>
            <input type="checkbox" class="radio" name="trade[]" value="4" @if(!empty($type2GetInfo->trade)) @if(in_array('4',explode('|',$type2GetInfo->trade))) checked="checked" @endif @endif />
            <span class="tishi">美容美发</span>
            <input type="checkbox" class="radio" name="trade[]" value="5" @if(!empty($type2GetInfo->trade)) @if(in_array('5',explode('|',$type2GetInfo->trade))) checked="checked" @endif @endif />
            <span class="tishi">百货超市</span>
            <input type="checkbox" class="radio" name="trade[]" value="6" @if(!empty($type2GetInfo->trade)) @if(in_array('6',explode('|',$type2GetInfo->trade))) checked="checked" @endif @endif />
            <span class="tishi">生活服务</span>
            <input type="checkbox" class="radio" name="trade[]" value="7" @if(!empty($type2GetInfo->trade)) @if(in_array('7',explode('|',$type2GetInfo->trade))) checked="checked" @endif @endif />
            <span class="tishi">家居建材</span>
            <input type="checkbox" class="radio" name="trade[]" value="8" @if(!empty($type2GetInfo->trade)) @if(in_array('8',explode('|',$type2GetInfo->trade))) checked="checked" @endif @endif />
            <span class="tishi">酒店宾馆</span>
            <input type="checkbox" class="radio" name="trade[]" value="9" @if(!empty($type2GetInfo->trade)) @if(in_array('9',explode('|',$type2GetInfo->trade))) checked="checked" @endif @endif />
