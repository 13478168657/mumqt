  ...
  <div class="main_r" id="main_r">
    ...
    <div class="write_msg">
      <p class="manage_title">
        ...
        <a href="addBasicVilla" class="click">独栋</a>
        <a href="addBasicOffices">纯写字楼</a>
        <a href="addBasicStore">住宅底商</a>
      </p>
      <ul class="input_msg">
        <li>
          ...
          <span class="tishi">环线房</span>
          <input type="checkbox" name="direction" class="radio"/>
          <span class="tishi">不限购</span>
          <input type="checkbox" name="direction" class="radio"/>
          <span class="tishi">现房</span>
          <input type="checkbox" name="direction" class="radio"/>
          <span class="tishi">学区房</span>
          <input type="checkbox" name="direction" class="radio"/>
          <span class="tishi">精装楼盘</span>
          <input type="checkbox" name="direction" class="radio"/>
          <span class="tishi">休闲度假</span>
        </li>
        <li>
          <label>&nbsp;</label>
        ...
        <li>
          ...
          <div class="dw" style="margin-left:0;">
            <a class="term_title"><span>在售楼盘</span><i></i></a>
            <div class="list_tag">
               <p class="top_icon"></p>
               <ul>
                 <li>在售楼盘</li>
        ...
        <li style="height:auto; overflow:hidden;">
          <label><span class="dotted colorfe">*</span>楼层状况：</label>
          <div class="float_l" style=" width:420px; height:70px;">
           <textarea class="txtarea" style=" width:400px; height:50px;"></textarea>
          </div>
          <span class="tishi colorfe">你还可以输入2字符</span>
