<div class="area_l">
    ...
    <div class="data">
        <dl class="qu">
            ...
            <dd>
                <p id="quname"></p>
                <p id="qucount"><span class="nums"></span></p>
            </dd>
        </dl>
        <dl class="jun">
    ...
    <li>
        ...
        <ol class="subway_list" id="house2">
            ...
            @foreach($subways as $key=>$subway)
                ...
                <li class="clearfix">
                    <span class="fl num" id="line_{{$subline[1]}}" lineId="{{$subline[1]}}" onclick="subwayLine({{$subline[1]}});" index="{{$index}}">{{$subline[0]}}</span>
