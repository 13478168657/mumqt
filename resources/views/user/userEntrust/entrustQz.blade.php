                        ...
                        <li class="entrust_l">
                            ...
                            <p>
                                ...
                                <span>期望租金：
                                    ...
                                    {{(int)$v->priceMin}}至{{(int)$v->priceMax}}
                                        @if($v->houseType1 == 3)
                                            元/月
                                        @else
                                            元/平米▪天
                        ...
                        <li class="entrust_r">
                            <?php
                                ...
                                @if($v->entrustState)
                                    ...
                                    <p><a href="/userEntrust/Qz-{{$v->id}}">查看委托</a></p>
                                    @endif
                                @else
            ...
            @else
                <div class="user_r">
                    <div class="no_data">
                        ...
                        <div class="no_info">
                            <p class="p1"><span>亲</span>，您暂无委托任何求租房源！</p>
                            <p>去<a href="/wantSaleRent/esfrent">委托房源</a></p>
                        </div>
                    </div>
                </div>
            @endif
