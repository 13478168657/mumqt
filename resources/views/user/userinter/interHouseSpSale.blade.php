...
@include('user.userHomeLeft')
  <div class="user_r">
    ...
    <p class="type_nav">
      <a class="click" href="/user/interHouse/shopsale">出售</a>
      <a href="/user/interHouse/shoprent">出租</a>
    </p>
    <div class="data_list">
    @if(!empty($houseData))
        ...
        @if($house->found)
         <div class="data_msg">
            <dl>
              <dt><a href="/housedetail/ss{{$house->_source->id}}.html"><img onerror="errorImage(this)" src="@if(!empty($house->_source->thumbPic)){{get_img_url('housesale',$house->_source->thumbPic,2)}}@else{{$houseImage}}@endif" alt="房源名称"></a></dt>
              <dd class="data_info">
                ...
                <p class="data_type">
                  ...
                  {{floor($house->_source->price1)}}元/平米
                </p>
                <p class="data_user">
         ...
         @foreach($houseData['info'] as $info)
            <div class="data_msg">
                <dl>
                    <dt><a href="/housedetail/ss{{$info->id}}.html"><img onerror="errorImage(this)" src="@if(!empty($info->thumbPic)){{get_img_url('housesale',$info->thumbPic,2)}}@else{{$houseImage}}@endif" alt="房源名称"></a></dt>
                    <dd class="data_info">
    ...
    @else
        <div class="no_data">
          ...
          <div class="no_info">
            <p class="p1"><span>亲</span>，目前没有关注出售商铺！您还可以去看看其它出售的商铺房源！</p>
            <p>去<a href="/spsale/area">关注商铺</a></p>
          </div>
        </div>
    @endif
    </div>
