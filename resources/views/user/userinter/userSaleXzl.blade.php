...
<div class="enter_house office">
  <div class="house_info">
    ...
    <div class="house_type">
      @if(empty($entrust))
      <form id="saveSaleXzl" action="/houseHelp/save/sale/office">
      @else
      <form id="saveSaleXzl" action="/houseHelp/save/sale/office/entrust">
      @endif
      ...
      <ul>
        ...
        <li class="no_clear">
          ...
          <div class="chose_build">
            <input type="text" onkeyup="searchCommunity(this,'2')" data-type="void" class="txt" placeholder="请输入楼盘名称" @if(isset($houseDetail->name)) value="{{$houseDetail->name}}" @else value="" @endif>
