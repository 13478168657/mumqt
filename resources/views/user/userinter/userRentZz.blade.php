...
<div class="enter_house house">
  <div class="house_info">
    ...
    <div class="house_type">
      @if(empty($entrust))
      <form id="saveRentZz" action="/houseHelp/save/rent/xq">
      @else
      <form id="saveRentZz" action="/houseHelp/save/rent/xq/entrust">
      @endif
      ...
      <ul>
        ...
        <li class="no_clear">
          ...
          <div class="chose_build">
            <input type="text" class="txt" onkeyup="searchCommunity(this,'3')" data-type="void" placeholder="请输入楼盘名称" @if(isset($houseDetail->name)) value="{{$houseDetail->name}}" @else value="" @endif>
        ...
        <li>
          ...
          @foreach(config('houseState.Zz.rentType') as $key => $val)
          <input type="radio" class="radio" name="rentType" @if(!isset($houseDetail) && $key == 1) checked="checked" @endif @if(isset($houseDetail->rentType) && $key == $houseDetail->rentType) checked="checked" @endif value="{{$key}}">
        ...
        <li>
          <label><span>*</span>租金：</label>
          <input type="text" class="txt width2 margin_l" name="price1" data-type="rent" @if(isset($houseDetail->price1)) value="{{floor($houseDetail->price1)}}" @else value="" @endif>
          <span class="zhi">元/月</span>
        </li>
        <li>
        ...
        <li>
          ...
          <div class="sheshi">
            @foreach(config('houseState.equipment1') as $key => $val)
              <span>
              <input type="checkbox" name="equipment[]" @if(isset($houseDetail->equipment) && in_array($key,explode('|',$houseDetail->equipment))) checked="checked" @endif value="{{$key}}" class="radio"/>
