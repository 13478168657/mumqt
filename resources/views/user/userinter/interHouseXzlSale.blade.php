...
<div class="user">
  ...
  <div class="user_r">
    ...
    <p class="type_nav">
      <a class="click" href="/user/interHouse/officesale">出售</a>
      <a href="/user/interHouse/officerent">出租</a>
    </p>
    <div class="data_list">
      @if(!empty($houseData))
          ...
          <div class="data_msg">
            <dl>
              ...
              <dd class="data_price">
                ...
                <p class="handle"><a class="gz" value="{{$house->_source->id}},2,{{$house->_source->houseType1}},0">取消关注</a><a class="look" value="{{$house->_source->id}}" data_type="{{$house->_source->houseType1}}">近期变化<i></i></a></p>
              </dd>
            </dl>
                  ...
                  <div class="data_msg">
                      <dl>
                          ...
                          <dd class="data_price">
                              ...
                              <p class="handle"><a class="gz" value="{{$info}},2,{{$info}},0">取消关注</a><a class="look" value="{{$info->id}}" data_type="{{$info->houseType1}}">近期变化<i></i></a></p>
                          </dd>
                      </dl>
                      <div class="change" style="display:none;">
                          <p class="top_icon"></p>
      ...
      <div class="no_data">
          ...
          <div class="no_info">
            <p class="p1"><span>亲</span>，目前没有关注出售写字楼！您还可以去看看其它出售的写字楼房源</p>
            <p>去<a href="/xzlsale/area">关注写字楼</a></p>
          </div>
      </div>
      @endif
    </div>
