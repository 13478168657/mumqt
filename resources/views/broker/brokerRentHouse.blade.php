...
<p class="submenu">
    ...
    @if(isset($data->_source->hs3) && ($data->_source->hr3) != 0)<a  class="click" href="/broker/{{$data->_id}}/rentHouse">租房</a>@endif
    @if(isset($data->_source->hs3) && ($data->_source->businessHouseCount) != 0) <a  href="/broker/{{$data->_id}}/business">商业</a>@endif
    <a  href="/broker/{{$data->_id}}/detail">个人信息</a>
</p>
<div class="broker_list">
    <div class="house_l">
        <div class="recommend build_list">
            @if(empty($rentHouse->hits))
                <div class="recommend build_list">
                    <div class="no_data">
