...
<div class="broker_list">
    <div class="house_l">
        <p class="select_nav">
            ...
            @if(!empty($data->_source->hs2))<a class="click" href="/broker/{{$data->_id}}/business/21">写字楼出售</a>@endif
            @if(!empty($data->_source->hr1))<a  href="/broker/{{$data->_id}}/business/12">商铺出租</a>@endif
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <div class="home_c">
                            ...
                            <div class="info_r">
                                <p class="p1">@if(empty($val->_source->price2))<span class="price">面议</span>@else<span class="price">{{$val->_source->price2}}</span>万/套@endif</p>
